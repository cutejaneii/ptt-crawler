...
from ptt_crawler import ptt_crawl, crawl_by_single_page, crawl_by_pages
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--mode', type=int, default=0, help='Query mode (default:0)  0: The NEWEST articles, 1:Articles from pageno to pageno, 2:Articles from certain page')
